...
if __name__ == '__main__':
    ...
    for i in dumps:
        ...
        if ndim == 2:
            ...
            # write grid information
            h5 = '%s_%d.h5' % (inpFile[:-4], i)
            xmfFile.writelines(geometry3d % (spatialOrder*cells[0], spatialOrder*cells[1], spatialOrder*cells[2], h5, top.name,
                                             spatialOrder*cells[0], spatialOrder*cells[1], spatialOrder*cells[2], h5, top.name,
                                             spatialOrder*cells[0], spatialOrder*cells[1], spatialOrder*cells[2], h5, top.name))
