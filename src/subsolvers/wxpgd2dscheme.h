#ifndef WXPGD2DSCHEME_H
#define WXPGD2DSCHEME_H
...
class WxpDG2Dscheme : public ApSubSolver<REAL>
{
  public:
    WxpDG2Dscheme()
            : ApSubSolver<REAL>("dg2dscheme") {
    }
