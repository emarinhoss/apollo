#ifndef APHWCALCULATEGRADIENTS_H
#define APHWCALCULATEGRADIENTS_H
...
class ApHWCalculateGradients : public ApNodalDGcalculateGradients<REAL>
{
  public:
 ...
 */
    ApHWCalculateGradients()
       : ApNodalDGcalculateGradients<REAL>("HWcalcGradients") {
    }

/** Destructor */
    virtual ~ApHWCalculateGradients();
 ...
 */
    void calculateGradients(wxNodalDGgeometry2D<REAL> *geom, WxCubature2d<REAL> *cub, Vec qk, Vec q_grads);
...
#endif // APHWCALCULATEGRADIENTS_H
