#ifndef APTWOFLUIDRMFANTENNABC_H
#define APTWOFLUIDRMFANTENNABC_H
...
class WxTwoFluidRMFAntennaBC : public WxGridBC<REAL>
{
  public:
 ...
 */
    WxTwoFluidRMFAntennaBC()
       : WxGridBC<REAL>("twoFluidAntennaBC") {
    }
 ...
 */
  ...
  private:
    REAL _omega, _baxial, _B0, _phase, _rise, _a, _b, _pi, _epsilon_r, _mu_r;

};

#endif // APTWOFLUIDRMFANTENNABC_H
