#ifndef APTWOFLUIDDIELECTRICBC_H
#define APTWOFLUIDDIELECTRICBC_H
...
class WxTwoFluidDielectricBC : public WxGridBC<REAL>
{
  public:
 ...
 */
    WxTwoFluidDielectricBC()
       : WxGridBC<REAL>("twoFluidDielectricBC") {
    }
...
#endif // APTWOFLUIDDIELECTRICBC_H
