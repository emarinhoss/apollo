#ifndef APEULERENTROPYEQN_H
#define APEULERENTROPYEQN_H
...
class WxEulerEntropyEqn : public WxHyperbolicEqn<REAL>
{
  public:
 ...
 */
    WxEulerEntropyEqn()
      : WxHyperbolicEqn<REAL>("eulerEntropyEqn") {
    }
