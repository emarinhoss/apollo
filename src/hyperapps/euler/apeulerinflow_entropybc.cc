...
#include "apeulerinflow_entropybc.h"
#include <wxmath.h>

template <typename REAL>
void
WxEulerInflowEntropyBC<REAL>::setup(const WxCryptSet& wxc, DM dm)
{
...
template <typename REAL>
void
WxEulerInflowEntropyBC<REAL>::applyBC(REAL *xc, REAL *nx, REAL *q, REAL *qaux, REAL *AreaInts, REAL *qBC)
{
