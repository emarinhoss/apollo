#ifndef APSIMPLIFIEDRMFBC_H
#define APSIMPLIFIEDRMFBC_H
...
class APsimplifiedRMFbc : public WxGridBC<REAL>
{
  public:
 ...
 */
  ...
  private:
    REAL _omega, _B0, _rise, _pi;

};


#endif // APSIMPLIFIEDRMFBC_H
