...
**183 Python tests, and 3 of them are 72% of the runtime.** Measured on a
...
| everything else (12 modules) | 174 | **4.0 s** |
| whole suite | 183 | ~895 s |

So run the 174 while you work and the whole suite before you push. The 174 need
...
suite reports `Ran 183 tests` and no skips.
