...
**185 Python tests, and 3 of them are 72% of the runtime.** Measured on a
...
| whole suite | 185 | ~895 s |

So run the 176 while you work and the whole suite before you push. The 176 need
...
suite reports `Ran 185 tests` and no skips.
